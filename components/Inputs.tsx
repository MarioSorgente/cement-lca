...
export default function Inputs({ state, setState }: Props) {
  ...
  return (
    <div className="card" style={{ marginBottom: 16 }}>
      ...
      {/* ROW 1 — Concrete strength | Exposure class | Volume */}
      <div
        className="grid"
        style={{
      ...
      {/* ROW 2 — Transport & A4 | Dosage mode */}
      <div
        className="grid"
        style={{
          gridTemplateColumns: '1.2fr 1fr', // transport slightly wider; dosage fits nicely
          gap: 12,
          alignItems: 'start',
        }}
      >
          ...
          <div className="input-group">
            ...
            <div>
              <label className="label" style={{ marginBottom: 6 }}>
                Global dosage (kg/m³)
                <Tooltip text="Applied when Dosage mode = Global. When Per-cement, change dosage in the table below." />
              </label>
              <input
                type="number"
                min={0}
